...
describe('widgets numériques', () => {
  ...
  it('utilise l’unité des préférences selon la grandeur mesurée', () => {
    const speed = drawNumeric(widget('WSpeed', { _unit: 'true' }), settings)
